...
Расширенное ТЗ, среда, шаблоны промптов и чеклисты. **Основной контекст агента:** [../../runbooks/agent-context.md](../../runbooks/agent-context.md) — прикладывай его в новый чат и работай по нему.

**Стартовый промпт:** см. [../../runbooks/agent-context.md](../../runbooks/agent-context.md), раздел «Универсальный стартовый промпт».
