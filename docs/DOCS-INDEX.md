...
**Обновлено:** 2026-03-13 (desktop stabilization complete; maintenance mode + weekly recheck added)
...
| **Разработка и агент**              | [AGENTS.md](../AGENTS.md), [runbooks/agent-context.md](runbooks/agent-context.md), [runbooks/next-iteration-focus.md](runbooks/next-iteration-focus.md), [runbooks/maintenance-mode.md](runbooks/maintenance-mode.md), [runbooks/phase-e-decision-log.md](runbooks/phase-e-decision-log.md), [runbooks/ai-tooling-setup.md](runbooks/ai-tooling-setup.md), [runbooks/cursor.md](runbooks/cursor.md), [runbooks/PROJECT-STATUS-SUMMARY.md](runbooks/PROJECT-STATUS-SUMMARY.md), [architecture/README.md](architecture/README.md)                                |
