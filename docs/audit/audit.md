...
| W2 / Step 2 | Coverage omit, fail_under | **ЧАСТИЧНО** | pipeline, transcript_log, caldav_poll выведены из omit; fail_under=69 (цель 70→80); в omit остаются main, audio/buffer, capture, dbus_service, server, diarizer, rag/*, local_llm (#56) |
...
- **#56 Coverage:** fail_under 69→70→80; вывести из omit по одному модулю с тестами (см. archive/audit/REMAINING_AND_PLAN_TO_100_2026.md).
