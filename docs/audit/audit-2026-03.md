# Аудит VoiceForge (март 2026)

**Дата:** 2026-03-05. **Контекст:** единый статус по [audit.md](audit.md) (W1–W20, Phase A–D), [plans.md](../plans.md) (roadmap 1–20), [architecture/overview.md](../architecture/overview.md).
...
5. **Возможности роста:** доведение качества до 100% (coverage, CVE); observability и продуктизация (OTel #71, алерты); расширяемость и платформы (plugins #72, macOS/WSL2 #50); упаковка (#73); качество AI (A/B #70, prompt caching #19).
6. **Приоритеты следующей фазы (3–5 направлений):** (1) Качество и надёжность до 100% — #56, #65, при необходимости W17/#66. (2) Observability и продуктизация — OTel #71, алерты/дашборды. (3) Расширяемость и платформы — plugins #72, #50. (4) Упаковка и распространение — #73, Flatpak/AppImage. (5) Качество AI и эксперименты — A/B #70, #19.
...
3. **Расширяемость и платформы** — плагины (#72); поддержка macOS/WSL2 (#50) для расширения аудитории.
...
3. **Phase D:** Вынести в отдельные итерации #70, #71, #72, #50, #73; обновить next-iteration-focus и при необходимости plans.md по приоритету.
4. **Документация:** Ссылку на этот отчёт добавить в [audit.md](audit.md); следующий шаг в next-iteration-focus — первый пункт из приоритетов (например реализация шага по #56 или выбор issue Phase D).
...
- Единый статус W1–W20 и Phase A–D: [audit.md](audit.md)
- План «оставшееся до 100%»: [archive/audit/REMAINING_AND_PLAN_TO_100_2026.md](../archive/audit/REMAINING_AND_PLAN_TO_100_2026.md)
- Полный снимок 2026-02-26: [archive/audit/PROJECT_AUDIT_AND_ROADMAP_2026.md](../archive/audit/PROJECT_AUDIT_AND_ROADMAP_2026.md)
