...
**Обновлено:** 2026-03-07 (автопилот: блоки 84, 97-ext)
...
**Сделано в сессии:** Блок 84 — E2E десктопа (Playwright: e2e/nav.spec.js, job desktop-e2e в CI, онбординг скрыт в тестах). Расширение i18n: заголовки вкладок Главная/Сессии/Затраты (data-i18n + I18N).

**Следующий шаг:** Ручная проверка десктопа и сборки; при желании — ещё строки UI в i18n или иные блоки из roadmap-100.
