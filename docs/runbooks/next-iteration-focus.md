...
**Обновлено:** 2026-03-07 (автопилот: раздел «Не реализовано» в roadmap)
...
**Сделано в сессии:** В roadmap-100-blocks.md добавлен раздел «Не реализовано (отложено)» с таблицей блоков 35, 44, 46, 49, 66, 68, 71, 75, 79 и кратким примечанием по каждому; обновлены DOCS-INDEX и next-iteration-focus.
