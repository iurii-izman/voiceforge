...
**Обновлено:** 2026-03-07 (автопилот: блоки 91, 94)
...
**Сделано в сессии:** Блок 91 — release notes из CHANGELOG (body_path в release.yml при пуше тега). Блок 94 — секция «По сценариям» в DOCS-INDEX (группировка по сценариям использования).

**Следующий шаг:** Продолжить roadmap-100: блоки 84, 87 (E2E, a11y), 90 (подпись updater), 96–100 или ручная проверка десктопа.
