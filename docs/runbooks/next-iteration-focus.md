...
**Обновлено:** 2026-03-07 (автопилот: доки 48, 79)
...
**Сделано в сессии:** Документация: calendar export-ical в таблице cli-commands-and-run; в calendar-integration.md — экспорт в iCal и заглушка блока 79 (создание события из сессии).
