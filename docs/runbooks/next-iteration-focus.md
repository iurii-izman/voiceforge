...
**Обновлено:** 2026-03-07 (автопилот: i18n расширение блока 97)
...
**Сделано в сессии:** Расширение i18n (блок 97): data-i18n и ключи I18N для виджета «Недавние сессии», кнопок быстрых действий (Запись, Анализ 60 сек), заголовков карточек настроек (Тема, Горячие клавиши, Обновления, Автозапуск, Звук, Окно, Режим окна); обновлён roadmap.

**Следующий шаг:** Ручная проверка десктопа/сборки; при желании — ещё блоки roadmap-100 или доп. строки UI в i18n (плейсхолдеры, подписи к полям).
