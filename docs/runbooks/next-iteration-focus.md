...
**Сделано в сессии:** i18n (блок 97): онбординг (заголовок, три шага, кнопка «Понятно», «Не показывать снова») и подсказка «Только чтение. Изменения — через конфиг…» в настройках; обновлён roadmap.
