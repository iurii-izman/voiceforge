...
**Обновлено:** 2026-03-07 (автопилот: E2E для блока 97, roadmap)
...
**Сделано в сессии:** E2E-тест «settings tab shows language selector (block 97)»: переход на вкладку Настройки, проверка заголовка и селектора языка (ru/en) через getByLabel; обновлён roadmap и next-iteration-focus.
