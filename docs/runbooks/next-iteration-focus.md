...
**Обновлено:** 2026-03-07 (автопилот: i18n тулбар сессий, виджет анализа)
...
**Сделано в сессии:** i18n (блок 97): подписи тулбара сессий (Период, Сортировка, Показать, По тегу) и виджета анализа (Последние, сек, Шаблон) через span+data-i18n; обновлён roadmap.
