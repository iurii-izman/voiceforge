...
**Сделано в сессии:** i18n (блок 97): поддержка data-i18n-placeholder в applyUiLang; плейсхолдеры поиска сессий; кнопка «Старт/Стоп записи» и «Запись идёт»; кнопка «Запустить анализ» и состояние «Загрузка…» (виджеты и JS) через t(); обновлён roadmap.
