...
**Обновлено:** 2026-03-07 (автопилот: блоки 96, 99)
...
**Сделано в сессии:** Блок 96 — подраздел «Шифрование локальных БД (опция)» в security-and-dependencies.md. Блок 99 — артефакт desktop-appimage в job desktop-build (bundle/appimage/).

**Следующий шаг:** Продолжить roadmap-100: блоки 84, 87 (E2E, a11y), 90 (подпись в CI), 97–98 (i18n, a11y), 100 (Flatpak) или ручная проверка десктопа.
