...
**Обновлено:** 2026-03-07 (автопилот: блоки 78, 81, 82, 83 roadmap-100)
...
**Сделано в сессии:** Реализованы блоки 78, 81, 82, 83: автостарт записи по календарю (calendar_autostart_enabled/minutes, поток в демоне); экспорт сессии в DOCX (pandoc, кнопка в UI); еженедельный отчёт (weekly-report --days/--output/--format); экспорт сессий в iCal (sessions-to-ical). Roadmap обновлён.

**Следующий шаг:** Продолжить roadmap-100: блоки 84–88 (тесты, a11y, бенчмарк), 89+ (CI, доки) или ручная проверка десктопа.
