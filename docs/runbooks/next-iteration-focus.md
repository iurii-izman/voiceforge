...
**Обновлено:** 2026-03-07 (автопилот: DOCS-INDEX, фокус следующего шага)
...
**Сделано в сессии:** i18n (блок 97): онбординг (заголовок, три шага, кнопка «Понятно», «Не показывать снова») и подсказка «Только чтение…» в настройках; E2E для вкладки Сессии (поиск, FTS, период, экспорт); обновлён roadmap.
