...
**Обновлено:** 2026-03-07 (автопилот: i18n тема, горячие клавиши, настройки, теги)
...
**Сделано в сессии:** i18n (блок 97): опции темы (Тёмная/Светлая/Как в системе), подписи «Запись:»/«Анализ:» у горячих клавиш, чекбоксы настроек (горячие клавиши, обновления, автозапуск, звук, свернуть в трей, компактный режим), кнопка «Проверить сейчас», «Теги:» и плейсхолдер тегов в деталях сессии; обновлён roadmap.
