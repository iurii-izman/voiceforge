...
**Обновлено:** 2026-03-07 (автопилот: блок 89 — сборка десктопа в CI)
...
**Сделано в сессии:** Добавлен job desktop-build в CI (блок 89): npm run tauri build для Linux, артефакт desktop-bundle-linux.

**Следующий шаг:** Продолжить roadmap-100: блоки 84, 87 (E2E десктоп, a11y), 90–91 (подпись updater, changelog), 92–94 (доки) или ручная проверка десктопа/сборки.
