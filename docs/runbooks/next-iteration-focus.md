...
**Обновлено:** 2026-03-07 (автопилот: i18n компакт-бар, затраты, экспорт списка)
...
**Сделано в сессии:** i18n (блок 97): компакт-бар (Запись, Анализ — quick_listen/widget_analyze), вкладка Затраты (7 дней, 30 дней, Экспорт отчёта), кнопка «Экспорт списка»; E2E-тест вкладки Затраты (кнопки 7d, 30d, export); обновлён roadmap.
