...
**Обновлено:** 2026-03-07 (автопилот: блоки 87, 90, 97, 98, 100)
...
**Сделано в сессии:** Блоки 87, 90, 98, 100 (a11y job, подпись в CI, main landmark, Flatpak в roadmap). Блок 97 — выбор языка (ru/en) в настройках, Store ключ, t()/applyUiLang(), навигация и заголовки из i18n.

**Следующий шаг:** Продолжить roadmap-100: блок 84 (E2E Playwright) или ручная проверка десктопа/сборки; при желании расширить i18n (остальные строки UI).
