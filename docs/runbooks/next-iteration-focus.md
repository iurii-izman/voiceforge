...
**Обновлено:** 2026-03-07 (автопилот: блоки 48, 60)
...
**Сделано в сессии:** Блок 60 — analyze --dry-run (без LLM, вывод сегментов/длины). Блок 48 — calendar export-ical --output file.ics (ближайшие события в .ics).
