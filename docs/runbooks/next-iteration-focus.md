...
**Обновлено:** 2026-03-07 (автопилот: блоки 57, 73)
...
**Сделано в сессии:** Блок 57 — индикатор «Analyzing…»/«Exporting…» в stderr при TTY для analyze и export. Блок 73 — раздел в rag-formats.md про индексацию по расписанию (cron, systemd timer).

**Следующий шаг:** Ручная проверка десктопа/сборки; при желании — ещё блоки roadmap-100 или расширение i18n.
