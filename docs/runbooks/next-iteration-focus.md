...
**Обновлено:** 2026-03-07 (автопилот: i18n контекстное меню, детали сессии, ошибки)
...
**Сделано в сессии:** i18n (блок 97): контекстное меню сессии (Открыть, Копировать ссылку, В избранное, Экспорт MD/PDF), модалка деталей сессии (заголовок, экспорт, копировать транскрипт/action items, Печать, aria-label Закрыть), кнопка «Копировать» у сегмента; префиксы «Ошибка:» и «Повторить» в динамическом HTML и в статусах; обновлён roadmap.

**Следующий шаг:** Ручная проверка десктопа/сборки; при желании — ещё блоки roadmap-100 или доп. строки UI в i18n.
