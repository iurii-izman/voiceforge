...
**Обновлено:** 2026-03-07 (автопилот: i18n опции сессий Период/Сортировка/Показать/По тегу)
...
**Сделано в сессии:** i18n (блок 97): опции выпадающих списков на вкладке Сессии — Период (Все, За сегодня, За неделю, За месяц), Сортировка (Сначала новые/старые, по длительности), Показать (Все, Только избранные), По тегу и Action items (Все, Только с action items); подпись «Период» обёрнута в span; обновлён roadmap.

**Следующий шаг:** Ручная проверка десктопа/сборки; при желании — оставшиеся блоки roadmap-100 (35, 44, 46, 49, 66, 68, 71, 75, 79 — требуют дизайна/бэкенда или ручных шагов).
