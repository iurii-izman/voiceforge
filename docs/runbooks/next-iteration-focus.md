...
**Обновлено:** 2026-03-07 (автопилот: блоки 69, 72)
...
**Сделано в сессии:** Блок 72 — подсказка «Analyzing… (≈ N–M s)» при TTY. Блок 69 — подраздел в security-and-dependencies.md про circuit breaker и retry для LLM.
