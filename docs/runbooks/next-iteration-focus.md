...
**Обновлено:** 2026-03-07 (автопилот: тест 48, i18n виджеты)
...
**Сделано в сессии:** Тест test_calendar_export_ical_smoke для calendar export-ical (блок 48). Расширение i18n: заголовки виджетов главной (Запись, Анализ, Стриминг, Недавние сессии, Ближайшие встречи, Затраты за 7 дней) — data-i18n + I18N.

**Следующий шаг:** Ручная проверка десктопа/сборки; при желании — ещё блоки roadmap-100 или строки UI в i18n.
