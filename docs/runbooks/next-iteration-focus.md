...
**Обновлено:** 2026-03-07 (автопилот: i18n статус-бар и баннер демона)
...
**Сделано в сессии:** i18n (блок 97): статус-бар (Проверка демона…, Демон доступен/недоступен), кнопки «Повторить» и «Повторить подключение», баннер демона, компакт-бар (Демон выкл/ок); setDaemonOff/setDaemonOk и applyUiLang используют t(); обновлён roadmap.
