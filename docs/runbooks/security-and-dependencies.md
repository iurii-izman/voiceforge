...
- **Desktop Rust `glib` (Dependabot #2):** принятый риск; алерт в GitHub закрыт (Dismiss → Risk accepted). Транзитивный glib 0.18.5 от Tauri/wry; устранение заблокировано на [tauri-apps/wry#1474](https://github.com/tauri-apps/wry/issues/1474). Подробно: [security-decision-log.md](security-decision-log.md).
