...
| **Максимум контекста (автопилот)** | Оба выше + при необходимости `@docs/audit/FULL_AUDIT_2026.md`, `@docs/roadmap-priority.md` | Полный аудит и приоритеты. |
| **Работа по задачам Phase A–D** | `@docs/audit/audit-to-github-map.md` | Маппинг слабостей на issues #55–73. |
