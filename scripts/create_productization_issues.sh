...
"productization,autopilot,feat,p0,phase:E" "$P0" "$M" "$BACKEND"
...
"productization,autopilot,feat,p0,phase:E" "$P0" "$S" "$BACKEND"
...
"productization,autopilot,feat,p1,phase:E" "$P1" "$S" "$BACKEND"
...
"productization,autopilot,feat,p1,phase:E" "$P1" "$L" "$BACKEND"
...
"productization,autopilot,feat,p1,phase:E" "$P1" "$M" "$BACKEND"
